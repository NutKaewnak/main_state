...
import rospy
import math
from controller.include.inverseKinematics import inverseKinematics
...
class test_invKine():
    ...
    def invKine(self):
        ...
        angle = invK.invKinematic(object_pos[0]-0.1, object_pos[1], 0.8)
        ...
        angle = invK.invKinematic(object_pos[0], object_pos[1], object_pos[2])

    ...
    def perform(self, perception_data):
        if self.state is 'init':
            ...
            if perception_data.device is 'VOICE':
                print perception_data.device, "KUY KUY", perception_data.input
            ...
            self.move_base.set_position(0, 0, radians(self.choosen_degree))
            self.timer.wait(5)
            ...
            if not self.timer.is_waiting():
                print 'Say========================================'
                self.skillBook.get_skill(self, 'Say').say('the answer of the question what color is cobalt is blue.')

...
class EEGPSR(AbstractTask):
    ...
    def perform(self, perception_data):
        if self.state is 'init' and perception_data.device == self.Devices.DOOR:
            ...
            self.subtask.to_location('START_EEGPSR')
            ...
            if self.subtask.state == 'finish' and perception_data.device == self.Devices.DOOR:
                ...
                self.say.say("My name is lumyai. I am ready for you command.")
            ...
            self.say = self.subtaskBook.get_subtask(self, 'Say')
            self.say.say(CommandExtractor.make_question(self.actions) + '. Please say robot yes or robot no.')
        ...
        elif self.timer.is_waiting() and perception_data.device == self.Devices.DOOR:
            self.say = self.subtaskBook.get_subtask(self, 'Say')
        ...
        elif self.state == 'perform_move' and perception_data.device == self.Devices.BASE_STATUS:

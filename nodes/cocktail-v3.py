...
class CockTailV3(BaseState):
    def __init__(self):
        ...
        self.people_name = ['michael', 'christopher', 'matthew', 'joshua',
                            'daniel', 'david', 'andrew', 'james', 'justin',
                            'joseph', 'jessica', 'ashley', 'brittany',
                            'amanda', 'samantha', 'sarah', 'stephanie',
                            'jennifer', 'elizabeth', 'lauren']
        self.isInit = False
    ...
    def main(self, device, data):
        ...
        if self.state is STATE.INIT:
            if device is Devices.door and data is 'open':
